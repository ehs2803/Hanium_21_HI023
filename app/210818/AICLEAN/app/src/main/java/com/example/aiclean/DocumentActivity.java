    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            for (int i=0; i < jsonArray.length(); i++)
            {
                ...
                TextView textViewLabel1 = (TextView)layoutExample.findViewById(R.id.textView7);
                textViewLabel1.setText(item1);

                TextView textViewLabel2 = (TextView)layoutExample.findViewById(R.id.textView10);
                textViewLabel2.setText(item2);

                TextView textViewLabel3 = (TextView)layoutExample.findViewById(R.id.textView11);
