    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final String urlStr = "http://192.168.123.3:5000/sensor"; //https://www.naver.com/";http://210.110.43.86:5000/
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final String urlStr = "http://192.168.123.3:5000/clean";//https://www.naver.com/";
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final String urlStr = "http://192.168.123.3:5000/document";//https://www.naver.com/";
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final String urlStr = "http://192.168.123.3:5000/effect";//https://www.naver.com/";
        ...
        button5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final String urlStr = "http://192.168.123.3:5000/device";//https://www.naver.com/";
